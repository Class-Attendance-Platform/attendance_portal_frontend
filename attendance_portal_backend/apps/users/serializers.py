...
from .models import StudentProfile, TeacherProfile, AdminProfile, DeviceBinding
...
class RegisterSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'id', 'userName', 'username', 'email', 'password', 'first_name', 'last_name',
    ...
    def validate(self, attrs):
        ...
        if role == User.Role.STUDENT:
            ...
            if not attrs.get('current_level'):
                raise serializers.ValidationError({'current_level': 'Required for students.'})
...
class UserMeSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = [
            'id', 'userName', 'username', 'email', 'first_name', 'last_name',
            'role', 'faculty', 'department', 'is_verified',
...
class StudentProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'faculty', 'department', 'is_verified',
            'student_id', 'current_level', 'current_semester', 'hardware_finger_id',
        ]
...
class TeacherProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            'email', 'faculty', 'department', 'is_verified', 'employee_id',
        ]
